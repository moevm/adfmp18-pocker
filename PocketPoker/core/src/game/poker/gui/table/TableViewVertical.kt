...
class TableViewVertical(game: PocketPoker, table: TableScreen) : TableViewBase(game, table) {
    ...
    private fun setUpButtons(){
        ...
        leftChoiceButton.setSize(330f, 90f)
        cenralChoiceButton.setPosition(375f, 20f)
        cenralChoiceButton.setSize(330f, 90f)
        rightChoiceButton.setPosition(730f, 20f)
        rightChoiceButton.setSize(330f, 90f)
