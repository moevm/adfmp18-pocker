...
class TableViewHorizontal(game: PocketPoker, table: TableScreen) : TableViewBase(game, table) {
    ...
    private fun setUpButtons(){
        ...
        leftChoiceButton.setPosition(20f, 1510f)
        leftChoiceButton.setSize(350f, 90f)
        cenralChoiceButton.setPosition(20f, 1135f)
        cenralChoiceButton.setSize(350f, 90f)
        rightChoiceButton.setPosition(20f, 760f)
        rightChoiceButton.setSize(350f, 90f)
