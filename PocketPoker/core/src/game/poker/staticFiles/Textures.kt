...
object Textures{
    ...
    val chatButton = Texture("pics/icon buttons/chat.png")
    val chatButtonDown = Texture("pics/icon buttons/chat clicked.png")
    val infoButton = Texture("pics/icon buttons/info.png")
    val infoButtonDown = Texture("pics/icon buttons/info clicked.png")
    val nextHand = Texture("pics/icon buttons/next hand.png")
    val nextHandDown = Texture("pics/icon buttons/next hand clicked.png")
    val prevHand = Texture("pics/icon buttons/prev hand.png")
    val prevHandDown = Texture("pics/icon buttons/prev hand clicked.png")
    val nextStep = Texture("pics/icon buttons/next step.png")
    val nextStepDown = Texture("pics/icon buttons/next step clicked.png")
    val playButton = Texture("pics/icon buttons/play.png")
    val playButtonDown = Texture("pics/icon buttons/play clicked.png")
    val pauseButton = Texture("pics/icon buttons/pause.png")
    val pauseButtonDown = Texture("pics/icon buttons/pause clicked.png")
